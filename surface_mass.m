...
[water,oxygen,CH4,O2s] = Reclaim(days_surface,water_perday_surface,oxygen_perday_surface,water_recycle_per,pep_to_surface);
food_mass_surface = surface_mass_food(days_surface,food_perday_surface,pep_to_surface);
...
mass_to_surface = oxygen + water + food_mass_surface + nitrogen_mass_surface + people_mass_surface + equipment_mass_surface + hydrogen_mass_surface+mass_ascent_vehicle + ascent_backup_supplies;
