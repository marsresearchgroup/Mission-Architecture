...
[water,oxygen,CH4,O2s,water_rec] = Reclaim(days_surface,water_perday_surface,oxygen_perday_surface,water_recycle_per,pep_to_surface,H2O,H2e,offset,E);
...
[mass_habitat,surface_area,height_habitat,width_habitat,Num_Pods,mass_per]=HabitatVolume2Mass(volume_habitat,density_heavy,density_light,thickness,connector_diameter,mass_connector);
